...
import HomeAboutModal from '@/components/home/HomeAboutModal.vue'
import { syncThemeChrome } from '@/utils/themeChrome'

const store = useRestaurantStore()
const { isMapView } = storeToRefs(store)
...
<template>
  <div class="relative shrink-0">
      ...
      <Transition name="actions-menu">
        ...
        >
          ...
          <button
            ...
            aria-label="关于"
          >
            <span class="action-menu-label">关于</span>
            <span class="action-menu-icon">
              <Info :size="18" class="md:w-5 md:h-5" />
            </span>
          </button>
        </div>
      </Transition>
    ...
    <HomeAboutModal :show="showAboutModal" @close="closeAboutModal" />
  </div>
</template>
